...
#
# Net::SMTP_auth::SSL is a small extension for SSL with SMTP
#

package Net::SMTP_auth::SSL;
...
# all other method taken from Net::SMTP (or Net::SMTP::SSL)
...
Net::SMTP_auth::SSL - Simple Mail Transfer Protocol Client with AUTHentication
...
=head1 SYNOPSIS
    ...
    # Constructors
    $smtp = Net::SMTP_auth::SSL->new('mailhost');
    $smtp = Net::SMTP_auth::SSL->new('mailhost', Timeout => 60);
...
=item new Net::SMTP_auth::SSL [ HOST, ] [ OPTIONS ]

This is the constructor for a new Net::SMTP_auth::SSL object. It is
...
L<Net::SMTP>, L<Net::SMTP::SSL> and L<Net::Cmd>
